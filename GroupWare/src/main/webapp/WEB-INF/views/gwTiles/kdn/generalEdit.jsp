   ...
   $(document).ready(function(){
      ...
      $("button#btnUpdate").click(function(){
       ...
       <%-- === 스마트에디터 구현 끝 === --%>
         ...
         frm.method = "POST";
         frm.action = "<%=ctxPath%>/t1/generalEditEnd.tw";
         frm.submit();   
      });
...
<div style="padding-left: 10%;">
 <a href="javascript:location.href='generalBoard.tw'" style="text-decoration:none; color: black;"><i class="fas fa-bullhorn fa-lg"></i>&nbsp;<span style="display: inline-block; font-size:22px;">공지사항</span></a>
