...
$(document).ready(function(){	
	...
	$(document).on('click','tr.docuInfo',function(){
		...
		goView(ano, vcatname, fromDate, toDate, vno, sort, searchWord);
	});
	
	if("${sort}"=="" && "${searchWord}"=="" && "${fromDate}"=="" && "${toDate}"=="" && "${vno}"==""){
		goSearch(1);
	}
	else {
	...
	function goView(ano, vcatname, fromDate, toDate, vno, sort, searchWord){
